...
var onNewGame = function onNewGame(event) {
  ...
  var data = getFormFields(this);
  api.createNewGame(data).then(ui.newGameSuccess).catch(ui.newGameFailure);
};
...
var gameOver = function gameOver(event) {
  ...
  gameLogic.playerX = true;
  api.overTrue(event).then(ui.gameOverSuccess).catch(ui.overTrueFailure);
  api.gameHistory().then(ui.gameHistorySuccess).catch(ui.gameHistoryFailure);
};

var gameWonX = function gameWonX(event) {
  gameLogic.gameIsOver = true;
  gameLogic.playerX = true;
  api.overTrue(event).then(ui.gameWonXSuccess).catch(ui.overTrueFailure);
  api.gameHistory().then(ui.gameHistorySuccess).catch(ui.gameHistoryFailure);
};

var gameWonO = function gameWonO(event) {
  gameLogic.gameIsOver = true;
  gameLogic.playerX = true;
  api.overTrue(event).then(ui.gameWonOSuccess).catch(ui.overTrueFailure);
  api.gameHistory().then(ui.gameHistorySuccess).catch(ui.gameHistoryFailure);
};
// #zero, #one, #two, #three, #four, #five, #six, #seven, #eight,
var checkForWin = function checkForWin(event) {
  if ($('#zero').html() === 'x' && $('#one').html() === 'x' && $('#two').html() === 'x') {
    $('#massage').html('x wins!');
    $('#zero, #one, #two').css('background-color', 'white');
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#three').html() === 'x' && $('#four').html() === 'x' && $('#five').html() === 'x') {
    $('#massage').html('x wins!');
    $('#three, #four, #five').css('background-color', 'white');
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#six').html() === 'x' && $('#seven').html() === 'x' && $('#eight').html() === 'x') {
    $('#six, #seven, #eight').css('background-color', 'white');
    $('#massage').html('x wins!');
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() === 'x' && $('#three').html() === 'x' && $('#six').html() === 'x') {
    $('#massage').html('x wins!');
    ...
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() === 'x' && $('#four').html() === 'x' && $('#eight').html() === 'x') {
    $('#massage').html('x wins!');
    $('#zero, #four, #eight').css('background-color', 'white');
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#two').html() === 'x' && $('#four').html() === 'x' && $('#six').html() === 'x') {
    $('#massage').html('x wins!');
    $('#two, #four, #six').css('background-color', 'white');
    gameWonX();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() === 'o' && $('#one').html() === 'o' && $('#two').html() === 'o') {
    $('#massage').html('o wins!');
    $('#zero, #one, #two').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#three').html() === 'o' && $('#four').html() === 'o' && $('#five').html() === 'o') {
    $('#massage').html('o wins!');
    $('#three, #four, #five').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#six').html() === 'o' && $('#seven').html() === 'o' && $('#eight').html() === 'o') {
    $('#massage').html('o wins!');
    $('#six, #seven, #eight').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() === 'o' && $('#three').html() === 'o' && $('#six').html() === 'o') {
    $('#massage').html('o wins!');
    $('#zero, #three, #six').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
    ...
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() === 'o' && $('#four').html() === 'o' && $('#eight').html() === 'o') {
    $('#massage').html('o wins!');
    $('#zero, #four, #eight').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#two').html() === 'o' && $('#four').html() === 'o' && $('#six').html() === 'o') {
    $('#massage').html('o wins!');
    $('#two, #four, #six').css('background-color', 'white');
    gameWonO();
    gameLogic.gameIsOver = true;
  } else if ($('#zero').html() !== '' && $('#one').html() !== '' && $('#two').html() !== '' && $('#three').html() !== '' && $('#four').html() !== '' && $('#five').html() !== '' && $('#six').html() !== '' && $('#seven').html() !== '' && $('#eight').html() !== '') {
...
var doTheGame = function doTheGame(event) {
  event.preventDefault();
  $('#massage').html('');
  if (gameLogic.playerX === true) {
    if ($(event.target).html() === '') {
      ...
      checkForWin();
      api.play(event).then(ui.playSuccess).catch(ui.playFailure);
    } else {
...
var checkIfOver = function checkIfOver(event) {
  event.preventDefault();
...
var overTrue = function overTrue(event) {
  var data = {
    'game': {
      'over': true
    }
...
var playSuccess = function playSuccess(response) {
  console.log(response);
  store.game = response.game;
};

var playFailure = function playFailure(error) {
...
var gameWonXSuccess = function gameWonXSuccess(response) {
  store.game = response.game;
  store.wins.xwins.push(1);
  console.log('gameWonX ran!');
};
var gameWonOSuccess = function gameWonOSuccess(response) {
  store.game = response.game;
  store.wins.owins.push(1);
  console.log('gameWonO ran!');
};
var overTrueFailure = function overTrueFailure(error) {
...
module.exports = {
  ...
  overTrueFailure: overTrueFailure,
  gameWonOSuccess: gameWonOSuccess,
  gameWonXSuccess: gameWonXSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
